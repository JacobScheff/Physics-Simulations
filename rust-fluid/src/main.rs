...
const GRID_SIZE: (i32, i32) = (4, 2); // How many grid cells to divide the screen into
...
const RADIUS_OF_INFLUENCE: f32 = 600.0; // MUST BE DIVISIBLE BY SCREEN_SIZE - The radius of the sphere of influence. Also the radius to search for particles to calculate the density
